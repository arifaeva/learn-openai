...
class EventDetail(BaseModel):
    ...
    date_time: str = Field(description="Date of the event")
...
def aggregate_event(current_event:str, new_event:str):
    pm = PromptManager()
    pm.add_message("system", f"You have a list of user's current events, and check if it's already exist. Here is the event: {current_event}")
...
def generate_confirmation(query):
    ...
    pm.add_message(
        ...
        Hey, I will make an event for you with this details: follow with this event details.
